...
export default {
  getCityUrl: '/v2/web/wechat_item/get_city_list_byGcid',
  getBannersUrl: '/v2/bannerManager/banner_pic/get_manager_list',
  getMenDianList: '/v2/web/wechat_item/get_item_list',
  getCode: '/v2/sms/worker/get_code',
  login: '/v2/customer/house_user/login_weChat_zuke',
  getUserHouseInfo: '/v2/web/compact/renter/get_list',
